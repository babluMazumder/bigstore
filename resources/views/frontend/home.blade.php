...
@section('mainSection')
  ...
  <div data-vide-bg="video/video" style="position: relative;">
    <div style="position: absolute; z-index: -1; inset: 0px; overflow: hidden; background-size: cover; background-repeat: no-repeat; background-position: 50% 50%; background-image: none;">
        <video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; width: 1521px; height: auto;">
            <source src="{{asset('frontend/')}}/video/video.mp4" type="video/mp4">
            <source src="{{asset('frontend/')}}/video/video.webm" type="video/webm">
            <source src="{{asset('frontend/')}}/video/video.ogv" type="video/ogg">
        </video>
    </div>
    <div class="container">
					...
					<div class="tab-pane active text-style" id="tab1">
						<div class=" con-w3l">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="{{url('product-details/'.$product->id)}}" data-toggle="modal" data-target="#myModal1" class="offer-img">
									...
									<div class="mid-1">
										...
										<div class="add">
                                            <a href="{{url('product-details/'.$product->id)}}"><button class="btn btn-danger my-cart-btn my-cart-b " data-id="1" data-name="Moong" data-summary="summary 1" data-price="1.50" data-quantity="1" data-image="{{asset('frontend/')}}/images/of.png">View Details</button></a>
										</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="6" data-name="Kurkure" data-summary="summary 6" data-price="0.70" data-quantity="1" data-image="{{asset('frontend/')}}/images/of5.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
