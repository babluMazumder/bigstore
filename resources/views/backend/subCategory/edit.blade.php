                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('sub-category')}}" class="breadcrumb-link">Sub Category List</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form id="form" data-parsley-validate="" novalidate="" action="{{url('sub-category/update')}}" method="post">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9 col-lg-10">
                                        <input id="inputEmail2" type="text" required="" name="name" value="{{$subCategory->name}}" placeholder="Name" class="form-control">
                                        @error('name')
                                            <div class="error text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
