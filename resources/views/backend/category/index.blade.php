                    ...
                    <div class="card">
                        <div class="row" style="padding: 10px 20px 0px 20px;">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="{{url('category/add-new')}}" class="btn btn-primary">Add New</a>
                            </div>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-primary">
                                        ...
                                        <td><a href="{{url('category/edit', $category->id)}}" class="btn btn-info">Edit</a><a onclick="return confirm('Are you sure to delete this item.?')" href="{{url('category/delete', $category->id)}}" class="btn btn-danger">Delete</a></td>
                                    </tr>
