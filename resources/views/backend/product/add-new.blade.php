                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form id="form" data-parsley-validate="" novalidate="" action="{{url('product/store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9 col-lg-10">
                                        <input id="inputEmail2" type="number" required="" name="price" placeholder="Price" class="form-control">
                                        @error('price')
                                            <div class="error text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9 col-lg-10">
                                        <input id="inputEmail2" type="number" required="" name="discounted_price" placeholder="Discounted Price" class="form-control">
                                ...
                                <div class="form-group row">
                                    <label for="input-select" class="col-3 col-lg-2 col-form-label text-right">is featured?</label>
                                    <div class="col-9 col-lg-10">
                                        <label class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="is_featured" value="1" class="custom-control-input"><span class="custom-control-label">Yes</span>
                                        </label>
                                        <label class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="is_featured" value="0" checked  class="custom-control-input"><span class="custom-control-label">No</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9 col-lg-10">
                                        <textarea id="inputEmail2" type="text" required="" name="description" placeholder="Description" class="form-control summernote" rows="10"></textarea>
                                        @error('name')
                                            <div class="error text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
